...
//SECRET data used for FindSecretWord

public class Secrets {
    public static final String EXPECTED_1 = "whatisup";
    public static final String EXPECTED_2 = "mathisfun";
    public static final String EXPECTED_3 = "congrats";
    public static final String EXPECTED_4 = "solved";
    public static final String EXPECTED_5 = "abcdefghijklmnopqrstuvwxyz";

    public static char[][] TRIPLETS_1 = {
            {'t','u','p'}, {'w','h','i'}, {'t','s','u'}, {'a','t','s'},
            {'h','a','p'}, {'t','i','s'}, {'w','h','s'}
    };

    public static char[][] TRIPLETS_2 = {
